...
type Service interface {
	...
	InsertProducts(id_admin int, products_spec ProductsSpec, createdBy string) (*Products, error)
...
type Repository interface {
	...
	CreateProducts(products *Products, createdBy string) (*Products, error)
